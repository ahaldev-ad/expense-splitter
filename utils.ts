import { Expense, Member, Settlement, BalanceSummary } from './types';
...
export const calculateBalances = (members: Member[], expenses: Expense[]): BalanceSummary[] => {
  const summary: Record<string, BalanceSummary> = {};
...
export const calculateSettlements = (balances: BalanceSummary[]): Settlement[] => {
